...
$lang = array (
	...
	'c_myset_export_no_pwd'			=> '私のパスワードセクションにパスワードがありません。',
	'c_myset_return'				=> '私の設定に戻る',

	'c_myset_import_mypwd'			=> 'パスワードのインポート',
	'c_myset_import_mypwd_log'		=> '私のパスワードログのインポート',
	'c_myset_import_mypwd_log_id_ko' => 'ログIDが見つからないか、エントリーがありません。',

	'c_myset_import_folder_missing'	=> 'インポートフォルダがありません。',
	'c_myset_import_folder_desc'	=> 'パスワードをインポートするには、以下のフォルダが存在し<strong>書き込み可能である必要があります</strong>',
	'c_myset_import_folder_create'	=> '手動でインポートフォルダを作成し、書き込み可能に設定してから、再度インポート手順を実行してください。',
	'c_myset_export_import_help'	=> '私のパスワードのエクスポート/インポートに関するヘルプ',
	...
	'c_myset_incorrect_verification' => '検証が正しくありません。',
	'c_myset_incorrect_pwd'			=> 'パスワードが正しくありません。',
	'c_myset_verification'			=> '検証',
	'c_myset_delete_all_mypwd'		=> 'すべてのパスワードを削除する',
	'c_myset_delete_all_mypwd_done'	=> '私のパスワードがすべて削除されました。',
	'c_myset_delete_all_mypwd_error' => '私のパスワードを削除する際にエラーが発生しました。',
	'c_myset_delete_all_mypwd_csrf_error' => 'CSRFエラーが発生し、私のパスワードがすべて削除されました。もう一度お試しください。',

	// views/my_settings
	'v_myset_my_account'			=> '私のアカウント',	// = v_users_my_account
 	'v_myset_my_settings'			=> '私の設定',	// = v_users_my_settings
 	...
 	'v_myset_del_mypwd_warning'		=> '警告：このアクションは永続的であり、元に戻すことはできません。',
 	...
 	'v_myset_import_log_id' 		=> 'インポートはIDと共に記録されました',
 	...
 	'v_myset_import_select_file'	=> '私のパスワードにインポートするパスワードエントリを含むファイル（拡張子CSV）を選択します。',
 	...
 	'v_myset_import_d8'				=> 'オプション電子メール（非暗号化）',
 	'v_myset_import_d9'				=> '任意：パスワード（非暗号化）',
 	'v_myset_import_d10'			=> 'オプションの備考',
