...
$lang = array (
	...
	'c_install_email'				=> '電子メールアドレス',
	'c_install_pwd'					=> 'パスワード',
	'c_install_repeat_pwd'			=> 'パスワードを繰り返す',
	'c_install_name'				=> '名前',
	'c_install_eula_agreement'		=> 'EULA同意書',
	'c_install_username_invalid'	=> 'ユーザー名に無効な文字が含まれています。',

	'm_install_incorrect_version' 	=> "不正なバージョンです。このため、index.php ファイルがソフトウェアの他の部分と一致しないことを示しています。デバッグ情報",
	...
	'm_install_tables_exist'		=> 'データベースのテーブルの一部または全部がすでに存在します。空のデータベースを選び、config.phpで設定してください。',
	...
	'm_install_table_not_exists'	=> 'このテーブルは存在しません',
	'm_install_keyphp_not_exists'	=> 'key.phpファイルが存在しません',
	'm_install_db_not_found'		=> 'データベースが見つかりません。',
	'm_install_upgrading_smaller'	=> "アップグレードしようとしているバージョンは、現在インストールされているバージョンよりも古いバージョンです。",
	'm_install_upgrading_smaller_to' => 'へのアップグレード',
	'm_install_upgrading_smaller_from' => 'インストール済み',

	'm_install_enc_key_not_defined'	=> '暗号化キーが定義されていません（key.phpがないか、暗号化キーが設定されていません）。',
	'm_install_errors_upgrading' 	=> 'クエリやプロセスのアップグレードにエラーがありました。',
	'm_install_contact_support'		=> 'サポートまでご連絡ください。',
	'm_install_upgrade_stopped'		=> 'アップグレードが停止しました。サポートに連絡してください。',
	'm_install_failed_query'		=> 'クエリ失敗',
	...
	'v_install_enter_data'			=> 'Team Password Manager の <strong>admin user</strong> のデータを入力してください（<strong>all of the fields are required</strong>）',
	'v_install_8cm'					=> '8文字以上',
	'v_install_agree_eula'			=> 'エンドユーザーライセンス契約に同意します',
	'v_install_submit_data'			=> 'インストール完了のためのデータ提出',
	...
	'v_install_tpm_installed_lic'	=> 'ライセンスを購入した場合は、サインイン後に設定 | ライセンス メニューに移動することで、ライセンスを登録できます。',
	'v_install_tpm_installed_maysignin' => '前のステップで作成したユーザでTeam Password Managerにログインできます。',
	'v_install_tpm_installed_signin' => 'Team Password Managerサインイン',
	...
	'v_upgrade_expired_note_1'		=> '<strong>Note:</strong>以下のライセンスは、サポートおよびアップデートの期間が終了しました。',
	...
	'v_upgrade_enter_adminit_desc'	=> 'AdminまたはIT部門のユーザー名とパスワードを入力し、「アップグレード」ボタンをクリックして次に進みます。',
