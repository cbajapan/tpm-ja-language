...
$lang = array (
	...
	'c_users_need_more'				=> 'さらにユーザーを追加する必要な場合は、次のリンクをクリックしてTeam Password Managerウェブサイトから追加ライセンスを購入してください：',
	...
	'c_users_api_keys_renewed'		=> 'HMAC API キーが更新されました。今後、HMACを使用したAPIコールの認証には、この新しいキーを使用する必要があります。',
	...
	'field_language'				=> '言語',
	'field_pwd'						=> 'パスワード',
	'field_repeat_pwd'				=> 'パスワードをもう一度してください',
	...
	'val_username_exists' 			=> 'このユーザー名はすでに存在しています。',
	...
	'c_users_clang'					=> '言語の変更',
	'c_users_clang_error'			=> '言語を変更する際にエラーば発生しました。',
	...
	'c_users_add_user_to_group_no_groups' => 'ユーザーを追加するグループがありません。',
 	...
 	'c_users_activate_cannot_more'	=> 'それ以上のユーザーをアクティブ化することはできません。',

 	'c_users_deactivate'			=> 'ユーザーの無効化',
 	'c_users_deactivate_not_yourself' => '<strong>自分で自分の活動を停止することはできません</strong>。他のユーザーを選択してください。',
 	...
 	'c_users_cnv_normal'			=> '通常の（LDAPではない）ユーザーへの変更',
 	'c_users_cnv_normal_already'	=> 'そのユーザーはすでに通常（LDAPではない）ユーザーです。',

 	'c_users_cnv_ldap' 				=> 'LDAPユーザーへの変更',
 	'c_users_cnv_ldap_already'		=> 'ユーザーがすでにLDAPユーザーである',

 	'c_users_import_step_1'			=> 'LDAP ユーザーのインポートステップ 1: ユーザーを取得するためのデータ',
 	...
 	'v_users_uinfo_invalid_hash_edit' => '注意：このユーザーのハッシュ値は無効で、サインインできません。これはおそらく、誰かがデータベースを改ざんしたことが原因です。この状況を修正するには、情報を保存してください。特に<strong>ユーザー名</strong>そして<strong>役割</strong>のフィールドにご注意ください。',
 	...
 	'v_users_btn_cnv_normal'		=> '通常（LDAPではない）ユーザーへの変更',
 	'v_users_btn_cnv_ldap'			=> 'LDAPユーザーへの変更',
 	...
 	'v_users_last_api_request'		=> '最終APIリクエスト',
 	...
 	'v_users_access_prjs_error' 	=> 'このユーザーがアクセスできる[PRJS]のリストを取得する際にエラーが発生しました。',
 	...
 	'v_users_api_keys_not_api_only'	=> 'このユーザーはAPI専用ユーザーではありません。HMAC API キーはユーザーアカウントに記載されています。',
 	...
 	'v_users_renew_api_keys_not_api_only' => 'このユーザーはAPI専用ユーザーではありません。このユーザーのHMAC API キーを更新するには、サインインして「私のアカウント」の 「API キー」タブをチェックする必要があります。',
 	...
 	'v_users_deactivate_note'		=> 'アクティブでないユーザーは、Team Password Managerにサインインできません。',
 	...
 	'v_users_cnv_normal_desc_3'		=> '<strong>* 重要：</strong>このユーザーを通常のユーザーに変更した後、「パスワードを変更」ボタンを使用して、このユーザーのパスワードを設定する必要があります。',
 	...
 	'v_users_enable_2fa_instr_2'	=> 'スマートフォンで<strong>Google Authenticator</strong>を開き、<strong>プラス（＋）ボタン</strong>をタップして、<strong>時間ベース</strong>を選択してください。',
 	'v_users_enable_2fa_instr_3'	=> '<strong>QRコード</strong>を Google Authenticator デバイスでスキャンしてください。お使いの端末にカメラが搭載されていない場合は、<strong>アカウント名</strong>および<strong>秘密鍵</strong>を手動で入力してください。',
 	...
 	'v_users_ldap_no_entries_found'	=> '提供されたデータを持つエントリーがありません。「検索フィルター」または「ベースDN」を変更してください。',
 	...
 	'v_users_ldap_no_users_selected'=> '選択されたユーザーはありませんでした。',
 	...
 	'v_users_ldap_entry_is_user'	=> 'このエントリーはユーザーであり、インポート可能です',
 	...
 	'v_users_ldap_import_num_users_found' => '該当するユーザー数',
 	'v_users_ldap_import_num_users_exist' => 'すでに存在するユーザー数',
 	'v_users_ldap_import_select_users' => 'インポートしたいユーザーを選択',
 	'v_users_ldap_import_cannot_select' => 'すべてのユーザーがすでにTeam Password Managerに存在するため、ユーザーを選択することはできません。',
 	...
 	'c_users_renew_api_keys_ok'		=> 'HMAC API キーが更新されました。今後、HMACを使用してAPIコールを認証するには、この新しいキーを使用する必要があります。',
	...
	'v_users_saml_email'			=> 'Eメールアドレスは、SAML ID プロバイダーでユーザを識別します。',
	'lbl_saml'						=> 'SAML',
	'v_users_saml_disabled'			=> '注：SAML認証は無効',
	'v_users_btn_cnv_normal_saml'	=> '通常の（SAML ではない）ユーザーへの変更',
	'v_users_btn_cnv_saml'			=> 'SAML ユーザーに変更する',
	'v_users_sidebar_saml'			=> 'SAMLユーザー',
	'c_users_cpwd_cannot_saml'		=> 'SAML ユーザーのパスワードは変更できません。',
	'c_users_setao_cannot_saml'		=> 'SAML ユーザーを API 専用ユーザーとして設定することはできません。',
	'c_users_cnv_normal_saml'		=> '通常の（SAML ではない）ユーザーへの変更',
	'c_users_cnv_normal_saml_not' 	=> 'ユーザーは SAML ユーザーではありません。。',
	'v_users_cnv_normal_saml_confirm' => 'このユーザーを通常（SAML ではない）ユーザーに変更しますか。',
	'v_users_cnv_normal_saml_desc'	=> 'このアクションにより、、ユーザーは SAML ユーザーから通常のユーザに変更されます。',
	...
	'v_users_cnv_saml_confirm'		=> 'このユーザーをSAMLユーザーに変更しますか？',
	'v_users_cnv_saml_desc'			=> 'このアクションにより、ユーザーは通常ユーザーから SAML ユーザーに変更されます。',
	'v_users_cnv_saml_desc_2'		=> 'ユーザーはEメールを使用して ID プロバイダで認証します。：',
	...
	// v12
	'v_ad_lowercase'				=> '<strong>注</strong>：<strong>Active Directory</strong>使用している場合、属性は<strong>小文字</strong>にしてください。例：sAMAccountNameではなくsamaccountname。',
