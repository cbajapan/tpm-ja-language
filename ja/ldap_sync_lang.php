...
$lang = array (
 	...
 	'c_ldap_sync_ldap_disabled'		=> '<strong>LDAP Authentication is disabled</strong>.LDAP同期を使用するには、設定｜LDAP認証で有効にする必要があります：',
 	...
 	'v_ldap_sync_explanation'		=> 'LDAP同期は、LDAP/ADサーバと同期してTeam Password ManagerのLDAPユーザとグループを作成/更新/削除します。',

 	'v_ldap_sync_disabled'			=> 'LDAP同期が無効になっています。',
 	...
 	'v_ldap_sync_disable_note'		=> '現在のオブジェクトは削除されません',

 	'm_ldap_sync_ldap_disabled'		=> 'LDAPは無効です。',
 	'm_ldap_sync_no_sync_object'	=> 'LDAP同期オブジェクトが存在しないか、読み込めませんでした。',
 	'm_ldap_sync_no_ldap_settings'	=> 'LDAP設定を読み込めませんでした。',
 	'm_ldap_sync_object_disabled'	=> 'LDAP同期オブジェクトが無効になっています。',
 	...
 	'm_ldap_sync_repeat_username_in_ldap' => 'LDAPの結果にユーザー名が重複しています。。',
 	'm_ldap_sync_repeat_email_in_ldap' => 'LDAPの結果に電子メールアドレスが重複しています。',
 	'm_ldap_sync_username_not_ldap'	=> '一致するユーザー名がLDAPユーザーでないか、同じLDAPサーバー内にいません。',
 	...
 	'v_lds_no_objects_filter'		=> 'このフィルターを持つオブジェクトはありません。',

 	'v_lds_header_id'				=> 'ID',
 	'v_lds_header_server'			=> 'LDAP/ADサーバー',
 	'v_lds_header_type'				=> 'アクション',
 	'v_lds_header_notes'			=> 'ショートノート',
 	'v_lds_header_executed'			=> '最新の実行',
 	'v_lds_header_state'			=> '状態',

 	'v_lds_sort_by_id'				=> 'IDで並び替え',
 	'v_lds_sort_by_server'			=> 'LDAP/ADサーバーで並び替え',
 	'v_lds_sort_by_type'			=> '同期タイプで並べ替え',
 	'v_lds_sort_by_notes'			=> 'ショートノートで並び替え',
 	'v_lds_sort_by_executed'		=> '最新の実行で並べ替え',
 	'v_lds_sort_by_state'			=> '状態で並べ替え',
 	...
 	'v_lds_by'						=> 'による',
 	'v_lds_latest_executed_on'		=> '最新実行日',
 	...
 	'c_ldap_sync_enable_object_confirm' => 'このオブジェクトを有効にしますか？',
	...
	'c_ldap_sync_object_deleted'	=> 'LDAP同期オブジェクトが削除されました。',
	...
	'c_ldap_sync_object_enable_to_test' => 'テストするには有効化する必要があります。',
	'c_ldap_sync_object_enable_to_execute' => '実行するには有効にする必要があります。',
	'c_ldap_sync_test_object_confirm' => 'このオブジェクトをテストしますか？',
	'c_ldap_sync_execute_object_confirm' => 'このオブジェクトを実行しますか？',

	'v_lds_test_end_error'			=> 'テストは以下のエラーで終了しました。',
	'v_lds_test_results'			=> 'テスト結果',
	'v_lds_test_users_explanation' 	=> '次のリストには、LDAPシステムで見つかったユーザーが表示されます。同期アクションは、Team Password Managerで何を実行するかを示します。マッチングはユーザー名で行われます。',
	'v_lds_test_del_users_explanation' => '次のリストには、このサーバーのTeam Password Managerで見つかったLDAPユーザーが表示されます。同期アクションは、Team Password Managerで何を実行するかを示します。マッチングはユーザ名で行われます。',
	'v_lds_execute_end_error'		=> '実行は以下のエラーで終了しました。',
	'v_lds_execute_results'			=> '実行結果',
	'v_lds_execute_users_explanation' => '次のリストは、LDAPシステムで見つかったユーザを示します。「同期アクション」はTeam Password Managerで実行されたことを示し。「完了」フィールドは結果を示します。マッチングはユーザー名で行われます。',
	...
	'v_lds_sync_action_none_do_not_delete' => 'なし、ユーザーはLDAPシステムに存在します',
	'v_lds_user_deleted'			=> 'ユーザー削除済み',
	...
	'v_lds_members_basedn'			=> 'メンバー：ベースDN',
	'v_lds_members_filter'			=> 'メンバー：検索フィルター',
	'v_lds_members_a_username'		=> 'メンバー：属性ユーザー名',
	'v_lds_members_a_email'			=> 'メンバー：属性電子メール',
	'v_lds_m_filter_explanation'	=> 'グループからユーザーを取得するために使用されるフィルター。[DN] はグループの DN（識別名）に置き換えられます。例',
	'v_lds_conditions_membership'	=> 'ユーザーをインポートするときと同じ条件が、メンバーを同期するときにも使用されます。',

	'c_lds_incorrect_action'		=> 'アクションが正しくありません。再度お試しください。',

	'v_lds_data_fetch_groups'		=> 'グループを取得するために必要なデータ',
	...
	'v_lds_action_addg_0'			=> '何もしない：グループは最新です',
	...
	'v_lds_test_groups_explanation' => '以下のリストは、LDAP システムで見つかったグループとそのメンバーを示しています。「同期アクション」フィールドは Team Password Manager で実行すべき操作を示します。グループの場合は名前で、メンバーの場合はユーザー名でマッチングが行われます。',
	...
	'v_lds_sync_action_none_do_not_delete_group' => 'なし、グループはLDAPシステムにあります',
	'v_lds_group_deleted'			=> 'グループを削除',
