...
$lang = array (
	...
	// controllers/mypwd
	'c_mypwd_invalid_pek_title'		=> '私のパスワード：無効な個人暗号キー',
	'c_mypwd_invalid_pek_desc'		=> '個人暗号化キーが無効です。サポートにご連絡ください。',
	...
	'c_mypwd_del_error'				=> 'パスワードの削除でエラーが発生しました。',
	'c_mypwd_del_csrf_error'		=> 'パスワードの削除でCSRFエラーが発生しました。',

	'c_mypwd_goto_pwd'				=> 'パスワード',

	'c_mypwd_copy_archived'			=> 'デスティネーション[PRJ]は<span class="label label-warning tpm-archived">アーカイブ</span>です。',
	'c_mypwd_copy_exists'			=> '保存先[PRJ]に既にこのパスワードが存在しています。',
	'c_mypwd_copy_cannot'			=> '保存先[PRJ]にパスワードを作成することはできません。',
	'c_mypwd_copy_prj_not_exists'	=> '保存先[PRJ]が存在しないか、アクセスできません。',
	...
	'c_mypwd_copy_pwd_prj_not_exist' => 'パスワード/[PRJ]が存在しないか、アクセスできません。',
	...
	// views/mypwd
	'v_mypwd_my_account'			=> '私のアカウント',	// = v_users_my_account
 	'v_mypwd_my_settings'			=> '私の設定',	// = v_users_my_settings
 	...
 	'v_mypwd_ccall_nothing'			=> 'コピーする対象がありません',
 	'v_mypwd_ccall_error'			=> 'コピーするデータの取得エラー',
 	'v_mypwd_cc_copied'				=> 'コピー',
 	'v_mypwd_cc_nothing'			=> 'コピーする対象がありません',
 	...
 	'v_mypwd_ccnotes_nothing'		=> 'コピーする対象がありません',
 	'v_mypwd_ccnotes_error'			=> 'コピーするデータの取得エラー',

 	'v_mypwd_sort_by_name'			=> '名前でソート',
 	'v_mypwd_list_auep'				=> 'アクセス / ユーザー名 / メールアドレス / パスワード',
 	'v_mypwd_sort_by_updated'		=> '更新日でソート',
 	'v_mypwd_updated'				=> '更新',
 	...
 	'v_mypwd_adv_search_any' 		=> '任意のフィールド',
 	'v_mypwd_adv_search_username_email' => 'ユーザー名またはEメール',
 	'v_mypwd_adv_search_tag'		=> 'タグ',

 	'v_mypwd_edit_info_saved_enc'	=> 'この情報は暗号化されて保存されます',
 	'v_mypwd_edit_tags_instruct'	=> '新しいタグを追加する場合はカンマ（,）を、リストから選択する場合は 「タブ」を使用します。',
 	...
 	'v_mypwd_edit_pwd_generated'	=> 'パスワードが生成されました',
 	
 	'v_mypwd_del_confirm'			=> 'このパスワードを削除しますか？',
 	'v_mypwd_del_warning'			=> '警告：このアクションは永続的であり、元に戻すことはできません。',

 	// v15
 	'm_mypwd_trash_error_transaction' => 'トランザクションのエラー',
 	'm_mypwd_trash_not_found'		=> 'パスワードが見つかりません',

 	'v_mypwd_moved_trash'			=> 'パスワードをゴミ箱に移動しました。',
	'v_mypwd_trash_conf1'			=> 'このパスワードをゴミ箱に移動しますか？',

	'c_mypwd_trash_error'			=> 'パスワードをゴミ箱へ移動する際にエラーが発生しました',
	...
	'v_mypwd_sort_by_trashed_on'	=> '削除日でソート',
	'v_mypwd_trashed'				=> '削除',

	'v_mypwd_not_shown_trash'		=> 'ゴミ箱の中にありません',

	'v_mypwd_trash_actions'			=> 'アクション',
	'v_mypwd_restore'				=> '復元',
	'v_mypwd_delperm'				=> '完全に削除',
	'm_mypwd_trash_not_found_trash'	=> 'このパスワードはゴミ箱にはありません',

	'c_mypwd_restore'				=> 'パスワードの復元',
	'v_mypwd_restore_conf1'			=> 'このパスワードを復元しますか？',
	'c_mypwd_cannot_restore_same_name' => '同じ名前の別のパスワードがあるため、このパスワードは復元できません。',
	'c_mypwd_return_trash'			=> 'ゴミ箱に戻す',
	'c_mypwd_restore_csrf_error'	=> 'パスワードは<strong>復元されません</strong>でした。',
	'c_mypwd_restore_error'			=> 'パスワードの復元エラー',

	'c_mypwd_delperm'				=> 'パスワードを完全に削除する',
	'v_mypwd_delperm_conf1'			=> 'このパスワードを完全に削除しますか？',
	'c_mypwd_delperm_csrf_error'	=> 'パスワードは完全に<strong>削除されません</strong>でした。',
	'c_mypwd_delperm_error'			=> 'パスワードを完全に削除する際にエラーが発生しました',
	'c_mypwd_delperm_ok'			=> 'パスワードは完全に削除されました。',
	...
	'c_pwd_cf_config_pwdarchived'	=> 'パスワードのカスタムフィールド設定は変更できません。<span class="label label-warning tpm-archived">アーカイブ</span>されているためです。',

	'vpwd_cf_instructions'		=> '必要なカスタムフィールドにラベルとタイプを入力します。注：フィールドタイプを「カスタムフィールドを使用しない」に設定しても、そのフィールドのデータは削除されません（フィールドにデータがある場合）。', // =home_lang
	'vpwd_cf_template'			=> 'テンプレート', // =home_lang
	'vpwd_cf_select'			=> 'フィールドに入力するテンプレートを選択する', // =home_lang
	...
	'c_pwd_cflabel_empty'		=> 'このフィールドの<strong>ラベル</strong>を空にすることはできない：<strong>カスタムフィールド', // <strong> gets closed in code // =home_lang
	...
	'v_mypwd_duplicate_title'	=> 'パスワードの複製',
	'v_mypwd_duplicate_btn'		=> '複製',

	'c_mypwd_duplicate'			=> 'パスワードの複製',

	'c_pwd_vrd_gen_pwd'			=> '新しいパスワードを生成する', // =home_lang
	'c_pwd_vrd_dup_custom'		=> 'カスタムフィールドの複製', // =home_lang
	'c_pwd_dup_pwd_copy_of' 	=> 'コピー', // =home_lang

	'vpwd_duplicate_new_name'	=> '新しい名称', // =home_lang
	'vpwd_duplicate_options'	=> 'オプション', // =home_lang
	'vpwd_duplicate_gen_pwd'	=> 'パスワードフィールドに新しいパスワードを生成する。', // =home_lang
	'vpwd_duplicate_cf' 		=> 'カスタムフィールドの複製', // =home_lang

	'c_mypwd_duplicate_error'	=> 'パスワードを複製する際にエラーが発生しました。',
	...
	'vpwd_list_sort_by'			=> 'ソート', // =home_lang
	'vpwd_list_file'			=> 'ファイル', // =home_lang
	'vpwd_list_files'			=> 'ファイル', // =home_lang

	'c_pwd_vrd_dup_files'		=> 'ファイルを複製', // =home_lang
