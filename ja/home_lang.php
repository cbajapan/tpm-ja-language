...
$lang = array (
	...
	'main_search_username_email'=> 'ユーザー名または電子メール',
	'main_search_tag'			=> 'タグ',
	...
	'main_show_tree'			=> 'ツリーを表示',
	'main_hide_tree'			=> 'ツリーを隠す',
	'main_refresh_tree'	 		=> 'ツリーをリフレッシュ',
	'main_filter_tree'	 		=> 'ツリーをフィルターにかける',
	'main_noprj_welcome_title'	=> 'Team Password Managerへようこそ',
	'main_noprj_welcome_line11' => '<strong>Team Password Manager</strong>は組織のパスワード管理に役立ちます。',
	'main_noprj_welcome_line12'	=> '各パスワードは<strong>[PRJ]</strong>に属しています。',
	'main_noprj_welcome_line21' => 'そこで、まずやっておきたいのが[PRJ]の作成です：',
	'main_noprj_welcome_line22' => '新しい [PRJ]',
	'main_noprj_welcome_line31' => '5分ほどお時間があれば、ヘルプページでTeam Password Managerの概要をご覧ください：',
	'main_noprj_welcome_line32' => 'ヘルプページ',
	'main_uselector_search'		=> 'ユーザーを検索',
	...
	'c_pwd_history_record'		=> '履歴レコード',
	'c_pwd_view_history_record' => '履歴レコードを表示',
	'c_pwd_ro_hr'				=> '読み取り専用ユーザーは、履歴レコードを表示できません。',

	'c_pwd_repeat'				=> 'リピート',
	'c_pwd_expiry_error'		=> '有効期限が正しくありません。次のフォーマットを使用してください：mm-dd-yyyy',
	'c_pwd_pwd_exists'			=> 'このパスワードはすでにこの[PRJ]に存在します。',
	...
	'c_pwd_error_saving_pwd_notes' => 'パスワードノートの保存中にエラーが発生しました。',

	'c_pwd_vres_managed_by'		=> 'によって管理',
	...
	'c_pwd_delete_pwd_archived'	=> 'このパスワードは、[PRJ]が<span class="label label-warning tpm-archived">アーカイブ</span>ため、削除できません。',
	'c_pwd_delete_pwd_perm'		=> 'このパスワードを削除する権限がありません（管理権限が必要です）。',
	'c_pwd_delete_pwd_error' => 'エラー: パスワードが<strong>NOT</strong>データベースエラーにより削除されました。',

	'c_pwd_copy_pwd'			=> 'パスワードのコピー',
	'c_pwd_copy_pwd_locked'		=> 'このパスワードはロックされています。コピーするにはロックを解除する必要があります。',
	'c_pwd_copy_pwd_dest_archived' => '[PRJ]の宛先は<span class="label label-warning tpm-archived">アーカイブ</span>です。',
	'c_pwd_copy_pwd_dest_exists' => 'このパスワードは宛先の[PRJ]に既に存在しています。',
	'c_pwd_copy_pwd_dest_cannot' => '宛先の [PRJ] にはパスワードを作成することはできません。',
	'c_pwd_copy_pwd_dest_not_found' => '宛先[PRJ]は存在しないか、アクセスできません。', 
	...
	'c_pwd_copy_pwd_ro'			=> '読み取り専用のロールしかないため、パスワードのコピーや作成はできません。',
	...
	'c_pwd_cflabel_empty'		=> '<strong>Label</strong>を空白にすることはできない：<strong>カスタムフィールド', // <strong> gets closed in code
	...
	'c_pwd_ext_sharing_disab'	=> '外部共有が無効になっています。設定-外部共有で有効にする必要があります。',
	'c_pwd_ext_sharing_locked'	=> 'パスワードがロックされているため、外部共有は変更できません。このパスワードを外部と共有したい場合は、ロックを編集し、ロックを解除する必要があります。',
	'c_pwd_ext_sharing_archived'=> '[PRJ] が <span class="label label-warning tpm-archived">アーカイブ</span> であるため、このパスワードの外部共有は編集できません。',
	...
	'vpwd_edit_locking_title' 	=> 'パスワードロックを編集',
	'vpwd_edit_locking' 		=> 'ロック',
	'vpwd_edit_extsha_title' 	=> '外部共有の編集',
	'vpwd_edit_extsha' 			=> '外部共有',
	...
	'vpwd_delete_pwd_conf2'		=> '警告：このアクションは永続的であり、元に戻すことはできません。',
	...
	'vpwd_edit_click_gen_pwd'	=> 'クリックしてパスワードを生成する',
 	...
 	'vpwd_edit_pwd_generated'	=> 'パスワードが生成されました！',
 	'vpwd_edit_info_saved_enc'	=> 'この情報は暗号化されて保存されました',
	...
	'vpwd_share_ext_notes2'		=> '外部で共有されているパスワードには、パスワード名の右側、スターのアイコンの隣にこのワールドリンクアイコンがあります。',
	'vpwd_share_ext_notes3'		=> '以下のデータは、外部からパスワードにアクセスする際に表示されます：パスワード名、プロジェクト名、アクセス、ユーザー名、電子メール、パスワード、有効期限、カスタムフィールド、メモ、ファイル。', 	

	'vpwd_locking_check'		=> 'ロックパスワード',
	'vpwd_locking_notes1'		=> 'ロックされたパスワードを使いたいユーザーは、理由を入力してロックを解除しなければなりません。',
	'vpwd_locking_notes3'		=> 'ロック解除されたパスワードは、そのユーザーのセッションが終わるまでロック解除されたままである。',
	'vpwd_locking_notes4'		=> 'ロックされたパスワードには、パスワード名の右側にあるスターのアイコンの隣に、このロックアイコン（ロック済み／ロック解除）が表示されます。',

	'vpwd_security_select_pm'	=> 'パスワードマネージャーを選択する',
	'vpwd_security_managed_by'	=> 'によって管理',
	'vpwd_security_change_pm'	=> '変更',
	'vpwd_security_pwd_sec'		=> 'パスワード・セキュリティ',
	'vpwd_security_pwd_sec_desc'=> 'このパスワードに対して、個別の<strong>users</strong>および/または<strong>groups</strong>に<strong>Set permissions</strong>してください。',
	'vpwd_security_show_with_perm' => '権限を持っているユーザー/グループを表示する',
	'vpwd_security_show_all' 	=> 'すべてのユーザー/グループを表示する',
	'vpwd_security_help_perm'	=> '権限に関するヘルプ',
	'vpwd_security_users'		=> 'ユーザー',
	'vpwd_security_groups'		=> 'グループ',
	'vpwd_security_members' 	=> 'メンバー',
	'vpwd_security_members_in' 	=> 'メンバー',
	'vpwd_security_ind_not1'	=> '個別の権限は設定できない。',
	'vpwd_security_ind_not2'	=> 'すべてのユーザーはこのパスワードの[PRJ]の管理者であり、グループは存在しません。',

	'vpwd_sec_help_donotset1'	=> 'ユーザー/グループに明示的な権限が設定されていません。',
	'vpwd_sec_help_donotset2'	=> 'ユーザーの有効権限は、そのユーザーが所属するグループとそのグループに設定されている権限、またはパスワードの[PRJ]に設定されている権限に基づいて計算されます。',
	'vpwd_sec_help_donotset3'	=> '権限がなければ、アクセスはできません。',
	'vpwd_sec_help_noaccess'	=> 'ユーザー/グループはパスワードにアクセスできません。',
	'vpwd_sec_help_read'		=> 'ユーザー/グループはパスワードデータの読み取りとファイルのダウンロードのみ可能です。',
	'vpwd_sec_help_edit' 		=> 'ユーザー/グループはパスワードデータを編集し、ファイルをアップロードすることができます（ただし、管理はできません）。',
	'vpwd_sec_help_manage' 		=> 'ユーザー/グループはパスワードを完全に管理できます。',
	'vpwd_sec_help_notes_lbl' 	=> '備考',
	'vpwd_sec_help_notes1' 		=> 'ユーザー権限はグループ権限よりも優先されます。',
	'vpwd_sec_help_notes2' 		=> '特定のパスワード権限は、そのパスワードに対して[PRJ]で設定されたものより優先されます。例外：[PRJ]管理者は[PRJ]とそのパスワードを完全に管理することができ、パスワードでこれを上書きすることはできません。',
	'vpwd_sec_help_notes3' 		=> '各ユーザーのパスワードに対する有効な権限は、パスワードのセキュリティタブに表示されます。',

	'vpwd_select_pm_user_role'	=> '<strong>User</strong>/ 役割',
	'vpwd_select_pm_users'		=> 'ユーザー',
	'vpwd_select_pm_not_found'	=> 'ユーザーが見つかりません',

	'vpwd_listcc_copied'		=> 'コピー',
	'vpwd_listcc_nothing'		=> 'コピーするものは何もありません！',
	...
	'vpwd_tab_ext'				=> '外部共有', // 外部共有と同じですが、モバイル画面用に縮小されています
	...
	'vpwd_not_shared_ext'		=> 'このパスワードは外部には公開されません。',
	'vpwd_ccurl_ext_copied'		=> 'コピー済み',

	'vpwd_history_description'	=> 'パスワード・フィールドのデータが変更されるたびに<strong>previous values</strong>はこのパスワード履歴に保存されます。',
	'vpwd_history_date_time'	=> '日時',
	'vpwd_history_user'			=> 'ユーザー',
	'vpwd_history_changed_fields' => '変更されたフィールド',
	'vpwd_history_view_values'	=> '値を表示',
	'vpwd_history_no_history'	=> 'このパスワードには履歴がありません。',
	'vpwd_history_only_changed_shown' => '変更されたフィールドのみが表示されます',
	'vpwd_history_record_not_exist' => 'このパスワードの履歴レコードは存在しません。',

	'vpwd_files_no_files' 		=> 'このパスワードにはファイルはありません',

	'vpwd_security_description'	=> 'このパスワードの有効な権限は以下の通りです。',
	'vpwd_security_name'		=> '名称',
	'vpwd_security_role'		=> '役割',
	'vpwd_security_permission'	=> '権限',
	...
	'c_prj_recent'				=> '最近',
	'c_prj_active'				=> 'アクティブ',
	'c_prj_not_found_title'		=> '[PRJ] が見つかりません',
	'c_prj_not_found_desc'		=> 'この[PRJ]が存在しないか、アクセスできません。',
	'c_prj_prj_exists_level' 	=> '[PRJ]はすでにこのレベルに存在しています。',

	'c_prj_edit_project'		=> '[PRJ]を編集する',
	'c_prj_edit_archived'		=> 'この[PRJ]は<span class="label label-warning tpm-archived">アーカイブ</span>ため編集できません。',
	'c_prj_edit_permission' 	=> 'この[PRJ]を編集するために必要な権限がありません。',
	'c_prj_new_project'			=> '新しい [PRJ]',
	'c_prj_new_no_more_projects'=> '申し訳ありませんが、これ以上[PRJS]を作成することはできません。',
	'c_prj_new_free'			=> '<strong>2ユーザーと5つの[PRJS]</strong>のみ許可されている<strong>free version</strong>を使用しています。より多くのユーザーと無制限の[PRJS]を持つためにライセンスを追加する必要があります。',
	'c_prj_new_buy' 			=> 'Team Password Managerのウェブサイトからライセンスを購入できます。',
	'c_prj_new_cannot'			=> '申し訳ありませんが、[PRJS]は作成できません。',
	'c_prj_new_no_access_parent'=> '親[PRJ]にはアクセスできません。',
	'c_prj_edit_error'			=> '[PRJ]の保存時にエラーが発生しました。',

	'c_prj_edit_sec_managed_by'	=> 'による管理',
	'c_prj_eps' 				=> '[PRJ] セキュリティを編集',
	'c_prj_eps_archived'		=> '<span class="label label-warning tpm-archived">アーカイブ</span>ため、この[PRJ]のセキュリティは編集できません',
	'c_prj_eps_perm' 			=> 'この[PRJ]のセキュリティを編集するのに必要な権限がありません（管理権限が必要です）。',
	'c_prj_eps_error_saving'	=> '[PRJ]のセキュリティ保存時にエラーが発生しました。',
	'c_prj_eps_no_members'		=> 'このグループにはメンバーはいません',

	'c_prj_delete'				=> '[PRJ]を削除',
	'c_prj_delete_archived'		=> '[PRJ]は<span class="label label-warning tpm-archived">アーカイブ</span>のため、削除できません。',
	'c_prj_delete_not_leaf'		=> 'この[PRJ]は[SUBPRJS]を持っているので削除できない。',
	'c_prj_delete_not_leaf_explain'	=> '現在、削除できるのは階層の末尾にある[PRJS]のみです。',
	'c_prj_delete_perm'			=> 'この[PRJ]を削除するのに必要な権限がありません（管理権限と管理者、[CAP_PRJ]マネージャ、またはITロールが必要です）。',
	'c_prj_delete_error'		=> 'エラー： [PRJ]は<strong>NOT</strong>データベースエラーにより削除されました。',

	'c_prj_archive'				=> '[PRJ]アーカイブ',
	'c_prj_archive_archived'	=> '[PRJ]はすでに<span class="label label-warning tpm-archived">アーカイブ</span>。',
	'c_prj_archive_perm'		=> 'この[PRJ]をアーカイブするのに必要な権限がありません（管理権限が必要です）。',
	'c_prj_archive_error'		=> '[PRJ]のアーカイブにエラーが発生しました。',

	'c_prj_unarchive'			=> '[PRJ]アーカイブ解除',
	'c_prj_unarchive_unarchived'=> '[PRJ]はすでに<strong>Un-Archived</strong>.',
	...
	'c_prj_cft_perm'			=> 'この[PRJ]のカスタムフィールドテンプレートを編集するのに必要な権限がありません（管理権限が必要です）。',
	'c_prj_cft_error'			=> 'テンプレートの保存時にエラーが発生しました。',

	'c_prj_tree_select_project'	=> '[PRJ]を選択する。',
	'c_prj_tree_root'			=> 'ルート',
	'c_prj_tree_all'			=> 'すべて',

	'c_prj_change_parent'		=> '親を変更する',
	'c_prj_select_new_parent'	=> 'の新しい親を選択する。',
	'c_prj_copy_pwd_select_prj'	=> '[PRJ]を選択し、パスワードをコピーする。',
	'c_prj_copy_pwd_grayed'		=> 'パスワードをコピーできない[PRJS]がグレー表示になっています',
	'c_prj_copy_my_pwd'			=> 'マイパスワードをコピーする',
	'c_prj_move_pwd_select_prj'	=> '[PRJ]を選択し、パスワードを移動する',
	'c_prj_move_pwd_grayed'		=> 'パスワードを移動できない[PRJS]がグレー表示になっています',
	'c_prj_move_my_pwd'			=> 'マイパスワードの移動',
	'c_prj_new_pwd_select_prj'	=> '[PRJ]を選択し、新しいパスワードを作成する。',
	'c_prj_new_pwd_grayed' 		=> 'パスワードを作成できない[PRJS]がグレー表示されます',
	'c_prj_new_prj_select_prj'	=> 'に新しい[PRJ]を作成するために、親[PRJ]（またはルート）を選択する。',
	'c_prj_tree_select_parent_project' => '親[PRJ]を選択',
	'c_prj_tree_select_parent_project_importing' => 'インポートに使用する[PRJ]の親（またはルート）を選択する。',
	'c_prj_select_prj_export'	=> 'からパスワードをエクスポートする[PRJ]（またはすべて）を選択。',
	'c_prj_select_prj_export_grayed' => 'パスワードをエクスポートできない[PRJS]がグレー表示されています。',

	'c_prj_change_parent_error'	=> '[PRJ]の親を変更するエラーが発生しました。',
	'c_prj_change_parent_no_access_parent' => '選択した新しい親 [PRJ] へのアクセス権がないため、[PRJ] の親をそれに変更することはできません。',
	'c_prj_change_parent_incorrect_parent' => '新しい親が正しくありません',
	'c_prj_change_parent_perm'	=> 'この[PRJ]の親を変更するために必要な許可を持っていません。',
	'c_prj_change_parent_archived' => '[PRJ]がアーカイブされたため、その親を変更することはできません。',

	// views/prj
	'vprj_new_pwd_phone'		=> '新しいパスワード',	// =new password but reduced for phones
	'vprj_new_pwd_title'		=> 'この[CAP_PRJ]にパスワードを作成する。',

	'vprj_unarchive'			=> 'アーカイブを解除',
	...
	'vprj_edit_security_title'	=> '[PRJ] セキュリティを編集',
	...
	'vprj_list_toggle_fav'		=> 'お気に入りに切り替え',
	...
	'vprj_no_notes'				=> 'この[PRJ]に関するノートはありません。',
	'vprj_files_no_files' 		=> 'この[PRJ]にはファイルがありません。',

	'vpr_sec_select_pm'			=> '[PRJ]マネージャーを選択する',
	'vprj_sec_set_to'			=> '[PRJ]セキュリティが設定されている',
	'vprj_sec_grant_all'		=> 'すべてのユーザーに以下の権限を与える。',
	'vprj_sec_individual'		=> 'この[PRJ]の権限を個々のユーザーおよび/またはグループに設定する。',
	'vprj_sec_effective'		=> 'この[PRJ]の有効な権限は以下の通り：',
	...
	'vprj_log_no_entries'		=> 'この[PRJ]に関するログエントリーはありません。',

	'vprj_enter_prj_search'		=> '[PRJ]を入力して検索する',
	'vprj_edit_sec_prj_security' => '[PRJ] セキュリティ',

	'vprj_sec_help_donotset1'	=> 'ユーザー/グループに明示的な権限が設定されていません。',
	'vprj_sec_help_donotset2'	=> 'ユーザーの有効な権限は、グループ内のメンバーシップと、それらのグループに設定されている権限に基づいて計算されます。',
	'vprj_sec_help_donotset3'	=> '権限が見つからなければ、アクセスはできません。',
	'vprj_sec_help_no_access'	=> 'そのユーザー/グループは、[PRJ]またはそのパスワードにアクセスできません。',
	'vprj_sec_help_traverse'	=> 'ユーザー/グループには[PRJ]名のみが表示されます。',
	'vprj_sec_help_read'		=> 'ユーザー/グループは[PRJ]データとそのパスワードのみを読むことができます。',
	...
	'vprj_sec_help_manage'		=> 'ユーザー/グループが[PRJ]とそのパスワードを完全にコントロールできます。',
	'vprj_sec_help_inherit'		=> 'ユーザー/グループは親[PRJ]に設定された権限を継承します。',
	'vprj_sec_help_notes1'		=> 'ユーザー権限はグループ権限よりも優先されます。',
	'vprj_sec_help_notes2'		=> '各ユーザの「PRJ」に対する有効な権限は、「PRJ」のセキュリティタブに表示されます。',

	'vprj_archive_project'		=> 'この[PRJ]をアーカイブしますか？',
	'vprj_archive_project_desc'	=> 'アーカイブされた[PRJ]（とそのパスワード）は変更できません。',
	'vprj_unarchive_project'	=> 'この[PRJ]のアーカイブを解除しますか？',

	'vprj_del_has_pwd'			=> 'この[PRJ]には以下のパスワードがあります。',
	'vprj_del_no_pwd'			=> 'この[PRJ]にはパスワードがありません。',
	'vprj_del_confirm_pwds'		=> 'この[PRJ]とすべてのパスワードを削除しますか？',
	'vprj_del_confirm_no_pwds'	=> 'この[PRJ]を削除しますか？',
	'vprj_del_warning'			=> '警告：このアクションは永続的であり、元に戻せません。',
	'vprj_del_deleted'			=> '[PRJ]は削除されました。',
	...
	'vpwd_ur_not_locked'		=> 'このパスワードはもうロックされていません',
	'vpwd_ur_already_granted'	=> 'このリクエストに対するロック解除の許可が<strong>granted</strong>',
	'vpwd_ur_already_revoked'	=> 'このリクエストに対するロック解除の許可が<strong>revoked</strong>',

	'vpwd_pwd_unlock_grant_btn'	=> 'ロック解除の許可を与える',
	'vpwd_pwd_unlock_revoke_btn'=> 'ロック解除許可の取り消し',
	'vpwd_pwd_unlock_grant_confirm'	=> 'ロック解除の許可を与えますか？',
	'vpwd_pwd_unlock_revoke_confirm'=> 'ロック解除の許可を取り消しますか？',
	'vpwd_pwd_unlock_grant_desc'	=> '確認すると、パスワードを解除してアクセスするためのリンクが記載された電子メールがユーザーに送信されます。',
	...
	'vpwd_unlock_perm_lbl_self' => 'あなたはこのパスワードの管理者なので、理由を入力するだけでパスワードを解除できます。',

	'vpwd_unlock_request_sent'	=> 'リクエストは送信され、管理者が許可または取り消すと、電子メールメッセージが届きます。',

	// v5
	'vpwd_locking_notify'		=> 'ロック解除時に通知',
	'vpwd_locking_request'		=> 'への許可を要請する。',
	'vpwd_locking_notify_pm'	=> 'パスワードマネージャー',
	...
	'vpwd_unlock_sending_req'	=> '許可リクエストの送信中 ... しばらくお待ちください',

	'vpwd_unlock_perm_lbl1_manage' => 'このパスワードの解除許可を管理者に要求する。',
	'vpwd_unlock_perm_lbl2_manage' => '管理者がパスワードの解除を許可すると、電子メールが送信されます。',

	'm_pwd_notif_manage_why_req' => 'あなたはパスワードの管理権限を持っているため、それを受け取りました。',
	'm_pwd_notif_why_req'		=> 'あなたはパスワードの管理者であるため、それを受け取りました。',

	'c_pwd_not_valid_requester1all' => 'このパスワードを解除するには、（自分自身ではない）管理者からの許可が必要ですが、許可を要求する有効なマネージャーが存在しません。ここでの有効とは、管理者が存在し、読み取り専用でもなく、API専用でもなく、アクティブなロールを持っていることを意味します。',

	// v7
	'c_prj_new_prj_select_prj_no_root'	=> '新しい[PRJ]を作成するために、親[PRJ]を選択する。',
	...
	'pwde_csrf_validation_error' => 'セッションの有効期限が切れました。再度お試しください。',
	'pwde_incorrect_pwd'		=> 'パスワードが正しくありません。再度をお試しください',
	...
	'c_pwd_move_pwd_archived' 	=> 'このパスワードは、[PRJ]が<span class="label label-warning tpm-archived">アーカイブ</span>ため、移動できません。',
	'c_pwd_link_pwd_archived' => 'その[PRJ]は<span class="label label-warning tpm-archived">アーカイブ</span>ため、このパスワードを別の[PRJ]にリンクすることはできません。',
	...
	'c_pwd_unlink_pwd_archived'	=> 'このパスワードは、[PRJ]が<span class="label label-warning tpm-archived">アーカイブ</span>ため、リンクを解除できません。',
	...
	'c_pwd_pwdarchived_edit'	=> 'このパスワードは<span class="label label-warning tpm-archived">アーカイブ</span>されているため編集できません。',
	'c_pwd_edit_pwd_sec_pwdarchived'=> 'このパスワードは<span class="label label-warning tpm-archived">アーカイブ</span>されているため、パスワードのセキュリティを変更できません。',
	...
	'c_pwd_link_pwd_pwdarchived' => '<span class="label label-warning tpm-archived">アーカイブ</span>ため、このパスワードを別の[PRJ]にリンクすることはできません。',
	'c_pwd_cf_config_pwdarchived' 	=> 'パスワードのカスタムフィールド設定は、<span class="label label-warning tpm-archived">アーカイブ</span>されているため、変更できません。',
	'c_pwd_ext_sharing_pwdarchived'=> '<span class="label label-warning tpm-archived">アーカイブ</span>ため、このパスワードの外部共有は編集できません。',

	'c_pwd_archive_pwd'			=> 'パスワードをアーカイブ',
	'c_pwd_archive_pwd_locked'	=> 'このパスワードはロックされています。アーカイブするにはロックを解除する必要があります。',
	'c_pwd_archive_pwd_pwdarchived'	=> 'このパスワードはすでに<span class="label label-warning tpm-archived">アーカイブ</span>されているため、アーカイブできません。',
	'c_pwd_archive_pwd_archived'	=> 'このパスワードは、[PRJ]が<span class="label label-warning tpm-archived">アーカイブ</span>であるため、アーカイブできません。',
	...
	'c_pwd_unarchive_pwd_archived'	=> 'このパスワードは、[PRJ]が<span class="label label-warning tpm-archived">アーカイブ</span>であるため、アーカイブを解除できません。',
	'c_pwd_unarchive_pwd_not_archived' => '<span class="label label-warning tpm-archived">アーカイブ</span>ではないため、このパスワードはアーカイブ解除できません。',
	...
	'c_pwd_cannot_restore_archived'	=> '[PRJ] が <span class="label label-warning tpm-archived">アーカイブ</span> であるため、パスワードを復元できません。',
	...
	'c_trash_restore_pwd_archived' => 'パスワードを復元しようとしている[PRJ]は<span class="label label-warning tpm-archived">アーカイブ</span>。パスワードを復元できるようにするには、アーカイブを解除してください。',
	...
	'v_bulk_actions_prj_archived'	=> 'この[PRJ]は<span class="label label-warning tpm-archived">アーカイブ</span>。',
